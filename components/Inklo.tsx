...
const Inklo = () => {
    ...
    switch (founderMood) {
      case 'GOD_MODE':
        return {
          ...
          glow: 'shadow-[0_0_40px_rgba(252,211,77,0.6)]'
        };
      case 'CHAOTIC':
        return {
          color: 'bg-neo-yellow',
  ...
  return (
    ...
    >
      ...
      {/* THE BODY - METALLIC SPHERE */}
      <div className={`w-28 h-28 rounded-full ${config.color} ${config.glow} border-4 border-neo-black relative overflow-hidden transition-colors duration-500 shadow-[inset_-10px_-10px_20px_rgba(0,0,0,0.2),_inset_10px_10px_20px_rgba(255,255,255,0.5)]`}>
        {/* METALLIC SHINE */}
